...
abstract class AppStyles {
  static final styleRegular12Grey600 = TextStyle(
    fontSize: 10.sp,
    color: AppColors.grey600,
  );
  static final styleMedium12Black = TextStyle(
    fontSize: 10.sp,
  ...
  static final styleBold24Black = TextStyle(
    fontSize: 22.sp,
  ...
  static final styleMedium19Primary = TextStyle(
    fontSize: 17.sp,
  ...
  static final styleBold18Grey600 = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeight.bold,
    color: AppColors.grey600,
  );
