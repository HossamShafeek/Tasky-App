...
import 'package:tasky/features/home/presentation/views/widgets/select_task_status.dart';
import 'package:tasky/features/home/presentation/views/widgets/task_texts_fields.dart';
import 'package:tasky/features/home/presentation/views/widgets/update_task_image.dart';

class UpdateTaskViewBody extends StatelessWidget {
  const UpdateTaskViewBody({super.key, required this.taskModel});
      ...
      listener: (context, state) {
        if (state is UploadImageSuccessState) {
          TaskOperationsCubit.get(context).updateTask(
            taskId: taskModel.id,
            imageFromModel: taskModel.image!,
          );
