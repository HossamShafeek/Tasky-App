...
import 'package:tasky/features/authentication/presentation/widgets/register_texts_fields_section.dart';
    ...
    return BlocConsumer<RegisterCubit, RegisterState>(
      listener: (context, state) {
        if (state is RegisterSuccessState) {
          CacheHelper.setData(key: 'access_token', value: state.registerEntity.accessToken);
          CacheHelper.setData(key: 'refresh_token', value: state.registerEntity.refreshToken);
          AppConstants.accessToken = state.registerEntity.accessToken;
          AppConstants.refreshToken = state.registerEntity.refreshToken;
